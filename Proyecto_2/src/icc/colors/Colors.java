...
public class Colors {
    ...
    /**
    ** Devuelve una cadena coloreada con el color especificado con el formato HIGH_INTENSITY.
    ** @param s La cadena a colorear.
    ** @param format El Formato a aplicar a dicha cadena.
    ** @return La cadena con el formato aplicado.
    **/
    public static String colorear(Object s, String format) {
      return format + Colors.HIGH_INTENSITY + s + RESTORE;
    }
}
